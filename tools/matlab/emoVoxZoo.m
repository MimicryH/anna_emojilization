...
% Licensed under The MIT License [see LICENSE.md for details]
  ...
  addpath('/usr/local/MATLAB/R2017b/toolbox/MatConvNet/matconvnet-1.0-beta25/matlab/')
  addpath('/usr/local/MATLAB/R2017b/toolbox/MatConvNet/matconvnet-1.0-beta25/contrib/mcnExtraLayers/matlab/')
  root=vl_rootnn;
  opts.modelDir = fullfile(root, 'data/models-import') ;
